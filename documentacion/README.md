...
| `plan-de-pruebas.md` | **Catálogo de casos de prueba** (permanente): **129 casos** por módulo con IDs `TC-*` (auth, onboarding, linaje, navegación, inicio, alumnos, grupos, locaciones, clases, asistencia, cuotas, alquileres, auditoría, mesas, postulación, evaluación), **matriz de roles/RLS**, resiliencia y **smoke test** de 22 casos. Se extiende con cada implementación. |
