...
- [ ] **Inicialización del Frontend:** Configurar el proyecto utilizando Next.js (React) junto con Tailwind CSS y shadcn/ui. Esto garantizará un diseño fluido e impecable centrado en el enfoque "Mobile-First".
